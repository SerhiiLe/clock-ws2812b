...
const uint8_t fontFix[][5] PROGMEM = {
	...
	{0x2E, 0x2A, 0x7F, 0x2A, 0x3A}, // $ 0x24 36 4
	...
	{0x00, 0xa0, 0x60, 0x00, 0x00}, // , 0x2c 44 12
	...
	{0xFC, 0x28, 0x24, 0x24, 0x18}, // p 0x70 112 80
	{0x18, 0x24, 0x24, 0x28, 0xFC}, // q 0x71 113 81
	...
	{0x7C, 0x12, 0x11, 0x12, 0x7C}, // А 0xd090 95
	...
	{0x77, 0x08, 0x7F, 0x08, 0x77}, // Ж 101
	{0x22, 0x41, 0x49, 0x55, 0x22}, // З 102
	...
	{0x07, 0x48, 0x28, 0x18, 0x07}, // У 114
	...
	{0x08, 0x54, 0x34, 0x14, 0x7c}, // я 0xd18f 158

	{0x7C, 0x55, 0x54, 0x45, 0x44}, // Ё 0xd081 159
	{0x38, 0x55, 0x54, 0x55, 0x08}, // ё 0xd191 160

	{0x3E, 0x49, 0x49, 0x41, 0x22}, // Є 0xd084 161
	{0xFF, 0x81, 0x99, 0x81, 0xFF}, // ¤ 0xd085 162
	{0x00, 0x41, 0x7F, 0x41, 0x00}, // I 0xd086 163
	{0x00, 0x41, 0x7E, 0x41, 0x00}, // Ї 0xd087 164
	{0x38, 0x54, 0x54, 0x44, 0x28}, // є 0xd194 165
	{0x00, 0x4C, 0x54, 0x64, 0x00}, // s 0xd195 166
	{0x00, 0x44, 0x7D, 0x40, 0x00}, // i 0xd196 167
	{0x00, 0x45, 0x7c, 0x45, 0x00}, // ї 0xd197 168
	{0x7E, 0x02, 0x02, 0x02, 0x03}, // Ґ 0xd290 169
	{0x7C, 0x04, 0x04, 0x04, 0x06}, // ґ 0xd291 170
	{0x06, 0x09, 0x06, 0x00, 0x00}, // ° 0xc2b0 171
	{0x40, 0x00, 0x40, 0x00, 0x40}, // ... 0xe280a6 172
	{0x40, 0x20, 0x14, 0x0C, 0x1C}, // ↗️ 0xE28697 173
	{0x04, 0x08, 0x50, 0x60, 0x70}, // ↘️ 0xE28698 174
};
