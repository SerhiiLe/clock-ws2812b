...
Обязательно переименовть файл include/defines.h.sample в include/defines.h, это нужно, если Вы захотите обновть прошивку, то не пришлось восстанавливать все параметры под Вашу конфигурацию.
